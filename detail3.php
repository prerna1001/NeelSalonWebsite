		...
		echo $dob;
          ...
          if($conn->connect_error){
               echo "Coonection not established, Error:" .$conn->connect_error;  //if connection failed then tis message will echo
					...
					$sql = "INSERT INTO details (id,dob,A,hand) VALUES('','$dob','$A','$hand')"; //prepare : An SQL statement template is created and sent to the database ............parameters('?') are left unspecified.
